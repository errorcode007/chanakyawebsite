      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <label htmlFor="service" className="block text-sm font-medium text-gray-700 mb-1">
                    {t('form.serviceNeeded')} {t('form.required')}
                  </label>
                  <select
                    id="service"
                    name="service"
                ...
                {status === 'error' && (
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-red-700 text-sm">
                    {t('form.errorMessage', { phone: siteInfo.phone })}
                  </div>
                )}
                ...
                >
                  {status === 'submitting' ? tc('buttons.sending') : tc('buttons.sendMessage')}
                </button>
          ...
          <div className="space-y-6">
            <div className="card">
              <h3 className="font-heading font-bold text-primary mb-4">{t('info.getInTouch')}</h3>
            ...
            >
              ...
              <div>
                <p className="font-semibold">{tc('buttons.chatOnWhatsApp')}</p>
                <p className="text-sm text-green-100">{tc('buttons.quickResponse')}</p>
              </div>
            </a>
